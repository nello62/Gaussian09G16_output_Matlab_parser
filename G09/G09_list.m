function T = G09_list()
% G09_LIST  Lists all G09_*.m functions in this toolbox with a one-line description.
%
%   G09_LIST() prints a formatted list of every G09_*.m file found in the
%   same folder as this function (name + H1 description line), sorted
%   alphabetically.
%
%   T = G09_LIST() also returns the list as a table with columns:
...
files = dir(fullfile(folder, 'G09_*.m'));
